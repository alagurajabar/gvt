        ...
        carousel_3D.each(function() {
            ...
            function rotateCarousel() {
                ...
                carousel_wrapper.css({
                    'transform': 'translateZ(' + -radius + 'px) ' + direction + '(' + angle + 'deg)'
                });
            }
            ...
            function changeCarousel() {
                ...
                cells.each(function(i) {
                    ...
                    cell.css({
                        'transform': direction + '(' + cellAngle + 'deg) translateZ(' + radius + 'px)' + direction + '(' + (angle * -1) + 'deg) '
                    });
...
(function($, window) {
    ...
    Lavalamp.prototype = {
        options: {
            current: '.current-menu-ancestor,.current-menu-item,.current-category-ancestor' // menu
                +
